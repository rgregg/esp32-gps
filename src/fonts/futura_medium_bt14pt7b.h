const uint8_t futura_medium_bt14pt7bBitmaps[] PROGMEM = {
...
const GFXglyph futura_medium_bt14pt7bGlyphs[] PROGMEM = {
  {     0,   1,   1,   8,    0,    0 },   // 0x20 ' '
  {     1,   3,  20,   9,    3,  -19 },   // 0x21 '!'
  {     9,   6,   7,   9,    1,  -18 },   // 0x22 '"'
...
const GFXfont futura_medium_bt14pt7b PROGMEM = {
  (uint8_t  *)futura_medium_bt14pt7bBitmaps,
  (GFXglyph *)futura_medium_bt14pt7bGlyphs,
  0x20, 0x7E, 33 };
